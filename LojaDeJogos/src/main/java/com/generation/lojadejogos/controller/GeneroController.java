...
import com.generation.lojadejogos.repository.GeneroRepository;
...
public class GeneroController {
	...
	@GetMapping("/generos/{categoria}")
	public ResponseEntity<List<Genero>> getByTitle(@PathVariable String categoria){
		return ResponseEntity.ok(generoRepository.findAllByCategoriaContainingIgnoreCase(categoria));
	}
